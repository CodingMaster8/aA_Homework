...
describe Dessert do
  ...
  let(:cake) { Dessert.new("cake", 8, chef) }
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("cake", "pie", chef) }.to raise_error(ArgumentError)
    end
  end

  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do 
      cake.add_ingredient("lobster")
      expect(cake.ingredients).to include("lobster")
    end
  end

  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["vanilla pudding", "lobster", "pepperoni", "salsa", "frosting"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(cake.serve).to eq("Chef Jason the Great Baker has made 8 cakes!")
    end
  end
